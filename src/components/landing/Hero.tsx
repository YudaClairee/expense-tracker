...
import { ArrowRight, TrendingUp, Shield, Smartphone, CheckCircle2 } from 'lucide-react'
          ...
          <div className="space-y-8 text-center lg:text-left">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                SpendSense membantu kamu melacak pengeluaran, menganalisis kebiasaan belanja, dan mencapai kebebasan finansial dengan bantuan AI.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              {isSignedIn ? (
                <Link href="/dashboard">
                  <Button size="lg" className="w-full sm:w-auto bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-6 text-lg shadow-lg shadow-primary/20 transition-all hover:scale-105">
                    Buka Dashboard
              ...
              <Button variant="outline" size="lg" className="w-full sm:w-auto px-8 py-6 text-lg border-2 hover:bg-accent/50">
                Lihat Demo
              </Button>
            </div>
            ...
            <div className="relative w-full max-w-md lg:max-w-full aspect-square lg:aspect-auto lg:h-full">
              ...
              <div className="absolute inset-x-0 top-10 bottom-10 bg-card/80 backdrop-blur-xl border border-white/20 dark:border-white/10 rounded-3xl shadow-2xl p-6 transform rotate-y-12 transition-transform hover:rotate-y-0 duration-700 ease-out">
                ...
                <div className="space-y-4">
                  <div className="text-sm font-semibold text-muted-foreground mb-4">Recent Activity</div>
                  {[1, 2, 3].map((i) => (
                    <div key={i} className="flex items-center justify-between p-3 rounded-xl bg-muted/30 hover:bg-muted/50 transition-colors">
                      <div className="flex items-center gap-3">
                        <div className={`w-10 h-10 rounded-full flex items-center justify-center ${i === 1 ? 'bg-orange-100 text-orange-600' : i === 2 ? 'bg-blue-100 text-blue-600' : 'bg-green-100 text-green-600'}`}>
                          {i === 1 ? <Smartphone className="w-5 h-5" /> : i === 2 ? <Shield className="w-5 h-5" /> : <TrendingUp className="w-5 h-5" />}
                        </div>
                        <div>
              ...
              <div className="absolute top-20 -right-4 lg:-right-12 bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-xl border border-border animate-bounce-slow z-10">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold text-green-600">+Rp 2.5jt</p>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute bottom-32 -left-4 lg:-left-8 bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-xl border border-border animate-bounce-slow delay-700 z-10">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs text-muted-foreground">Keamanan</p>
                    <p className="text-sm font-bold">Enkripsi 256-bit</p>
                  </div>
                </div>
              </div>
            </div>
