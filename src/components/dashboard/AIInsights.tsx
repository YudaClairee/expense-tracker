      ...
      setInsights([
        {
          id: "fallback-1",
          type: "info",
          title: "AI Sementara Tidak Tersedia",
          message:
            "Kami sedang memperbaiki layanan AI insights. Silakan coba lagi nanti.",
        ...
        prev.map((a) =>
          a.insightId === insight.id
            ? {
                ...a,
                answer:
                  "Maaf, terjadi kesalahan saat menghasilkan jawaban. Silakan coba lagi.",
                isLoading: false,
              }
            : a
        )
    ...
    <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl">
      ...
      <div className="mt-4 sm:mt-6 pt-3 sm:pt-4 border-t border-gray-100 dark:border-gray-700">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-0">
          <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400"></div>
          <button
            onClick={loadInsights}
          ...
          >
            ...
            <span className="hidden sm:inline">Muat Ulang Rekomendasi →</span>
          </button>
        </div>
      </div>
    </div>
