...
const steps = [
  {
    ...
    title: "Daftar Akun",
    description:
      "Buat akun gratis dalam hitungan detik. Cukup gunakan email atau akun Google kamu.",
  ...
  },
  {
    ...
    description:
      "Mulai catat pemasukan dan pengeluaranmu. Bisa manual atau upload struk (coming soon).",
    color:
  ...
  },
  {
    ...
    description:
      "Lihat laporan keuangan otomatis dan dapatkan insight AI untuk mulai berhemat.",
    color:
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Tidak perlu ribet. WallyAI didesain untuk siapapun yang ingin
            mengatur keuangan dengan simpel.
          </p>
        </div>
        ...
        <div className="relative grid md:grid-cols-3 gap-8">
          ...
          {steps.map((step, index) => (
            ...
            >
              <div
                className={`w-24 h-24 rounded-3xl ${step.color} flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 transition-transform duration-300`}
              >
