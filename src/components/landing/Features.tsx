...
import { BarChart3, PieChart, Target, Zap, ArrowUpRight } from "lucide-react";
...
const features = [
  {
    ...
    description:
      "Analisis mendalam pola pengeluaranmu dengan bantuan Artificial Intelligence. Dapatkan saran personal untuk berhemat.",
  ...
  },
  {
    ...
    title: "Input Cepat",
    description:
      "Catat transaksi dalam hitungan detik. Tanpa ribet, langsung tercatat.",
  ...
  },
  {
    ...
    description:
      "Set target tabungan dan batasi pengeluaran per kategori agar tidak boncos.",
    className: "md:col-span-1",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center space-y-4 mb-20">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Kami menggabungkan teknologi AI dengan desain intuitif untuk
            memberikan pengalaman manajemen keuangan terbaik.
          </p>
        </div>
